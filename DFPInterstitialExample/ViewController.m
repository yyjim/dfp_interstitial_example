...
@property (nonatomic, weak) IBOutlet UITextField *adUnitIDTextField;

@end

@implementation ViewController

- (NSString *)defaultAdUnit
{
    NSString *adUnitID = @"/267320516/002";
    return adUnitID;
}
...
- (void)viewDidLoad
{
    ...
    self.adUnitIDTextField.text = [self defaultAdUnit];
    [self startNewGame];
}
...
{
    NSString *adUnitID = self.adUnitIDTextField.text ?: [self defaultAdUnit];
...
{
    NSString *adNetwork = ad.adNetworkClassName ?: @"unknown network";
    NSString *placementId = ad.adUnitID ?: @"unkown id";
    NSLog(@"Ads - Will present ad from network:%@ with unit id:%@", adNetwork, placementId);
}
